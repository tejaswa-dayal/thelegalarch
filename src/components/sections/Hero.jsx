...
const Hero = () => {
    return (
        <section className='h-[90vh] w-full block'>
        ...
        <h1 className='font-bold text-4xl md:text-6xl '>The Legal Arch</h1>
                ...
                <div className='flex justify-center gap-20 items-center'>
                    ...
                    <button className='border-2 border-primary-lighter text-white rounded-full py-2 px-4 text-center hover:bg-primary-lighter transition-colors duration-300 ease-in-out font-bold mt-10'>Contact Us</button>
                </div>
            </div>
        </div>
        </div>
